...
void python::export_geometry()
{
	...
	class_< vertex_t, vertex_ptr_t >("vertex", "Mesh vertex")
		...
		.add_property("verts", range(&vertex_t::vertices_begin, &vertex_t::vertices_end))
		.add_property("edges", range(&vertex_t::edges_begin, &vertex_t::edges_end))
		.add_property("verts_size", &vertex_t::vertices_size, "Number of vertices")
	...
	class_< edge_t, edge_ptr_t >("edge", "Mesh edge")
		.add_property("verts", range(&edge_t::vertices_begin, &edge_t::vertices_end), "Adjacent vertices")
		.add_property("verts_size", &edge_t::vertices_size, "Number of adjacent vertices" )
        ...
        .add_property("v0", &edge_t::vertices_front, "First adjacent vertex")
        .add_property("v1", &edge_t::vertices_back, "Second adjacent vertex")
		.def(self == self)
		.def(self != self)
	...
	class_< face_t, face_ptr_t >("face", "Planar mesh face")
		...
		.add_property("verts", range(&face_t::vertices_begin, &face_t::vertices_end),"Adjacent vertices")
		.add_property("verts_size", &face_t::vertices_size, "Number of adjacent vertices")
	...
	class_< mesh_t, boost::shared_ptr< mesh_t > >("mesh","Non-manifold surface mesh")
		.def("set_point", &mesh_t::set_point, "Change the coordinates of a vertex", args("v","point"))
		.def("add_vertex", &mesh_t::add_vertex, "Add a free vertex to the mesh and return the index", args("v") )
		...
		.add_property("verts", range(&mesh_t::vertices_begin, &mesh_t::vertices_end))
		.add_property("verts_size", &mesh_t::vertices_size)
